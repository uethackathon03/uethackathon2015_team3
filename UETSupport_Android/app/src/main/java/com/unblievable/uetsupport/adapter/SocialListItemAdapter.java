...
public class SocialListItemAdapter extends BaseAdapter {
    ...
    private ArrayList<com.unblievable.uetsupport.objects.Thread> threads;

    public SocialListItemAdapter(Activity activity, int layoutId, ArrayList<com.unblievable.uetsupport.objects.Thread> threads) {
